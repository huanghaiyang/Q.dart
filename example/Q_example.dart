...
//  }));
  ...
  app.route(Router("/redirect_user", POST, (Context ctx, [HttpRequest req, HttpResponse res]) async {
    return Redirect("name:user", GET, pathVariables: {"user_id": "1", "name": "huang"});
  }));
